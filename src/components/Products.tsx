...
const Products = () => {
  const products = [
    ...
    },
    {
      ...
      description: "Web for physical photo of trade in device at iBox store",
    ...
    {
      name: "Ekonoservice",
      description: "Website landing page & online courses for mobile phone technicians",
      icon: "ekono-icon.png",
      framework: "react-icon.png",
      width: 70,
    },
    {
      name: "Easy Survey",
      description: "Website for ordering property, insurance, and vehicle survey services",
      icon: "easy-icon.png",
      framework: "react-icon.png",
      width: 70,
    },
